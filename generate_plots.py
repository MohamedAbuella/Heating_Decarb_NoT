...
def plot_social_intervention(systemData, year, scenario):
    ...
    plt.plot(hours, elec_demand, label="Base Profile", color='blue', linewidth=linewidth)
    plt.plot(hours, adjusted_elec, label="Monte Carlo Profile", color='red', linewidth=linewidth)
    ...
    # ---- Second Figure: Gas ----
    plt.figure(figsize=(10, 6))
    plt.plot(hours, gas_demand, label="Base Profile", color='blue', linewidth=linewidth)
    plt.plot(hours, adjusted_gas, label="Monte Carlo Profile", color='red', linewidth=linewidth)
