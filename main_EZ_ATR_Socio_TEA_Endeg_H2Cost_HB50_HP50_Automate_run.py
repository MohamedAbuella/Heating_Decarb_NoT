...
global case_fg, solver_type, eq_fg, eps_imax, h2_fg, idiv_plt_sw, ccs_fg, \
        ...
        intervention_levels, base_sw, hour_of_day, EZ_ATR_fg
...
def initial_run_OPGF(model, systemData, H2_prop):
    ...
    multinet = run_OPGF(hour_of_day, genData,  systemData, H2_prop, temp_system, price_fg, 
                        ...
                        HPHB_sw, EZ_ATR_fg, list_ele_demand, list_gas_demand) # Running the OPGF
...
def run_techno_economic_analysis(t, year, scenario, systemData, temp_system, output_dir):
    ...
    output_dir = f'Output/Res_{HPHB_mix_fg}_Price{price_fg}_EZATR_{EZ_ATR_fg}/MCP'+'/'+case_fg+'/Outs/'+str(scenario)+'/imax_'+str(eps_imax)+'_prcfg_'+str(price_fg)+'_yrfg_'+str(year_fg)+'_'+str(year)
    ...
    for HPHB_sw in scenarios_list:
        for h2_plt in h2_proportions:
            ...
            for scenario in scenarios:
                ...
                if ccs_fg == 0:
                    output_dir = f'Output/Res_{HPHB_mix_fg}_Price{price_fg}_EZATR_{EZ_ATR_fg}/MCP/{case_fg}/H_{H2_prop}/Without_CCS/Wind_limit_{ws_limit}/ext_grid_{ext_sw}/price_{price_fg}/{HPHB_sw}/Social_{base_sw}/{scenario}'
                if ccs_fg == 1:
                    output_dir = f'Output/Res_{HPHB_mix_fg}_Price{price_fg}_EZATR_{EZ_ATR_fg}/MCP/{case_fg}/H_{H2_prop}/With_CCS/Wind_limit_{ws_limit}/ext_grid_{ext_sw}/price_{price_fg}/{HPHB_sw}/Social_{base_sw}/{scenario}'
